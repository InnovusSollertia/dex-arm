...
# obj_start_pos=[45,215]
obj_start_pos=[42,225]
...
if __name__ == "__main__":
    ...
    # Handling equipment
    Com_dev1 = Serial_dev()
    Com_dev1.set_com("COM3")
    Com_dev1.set_bps(115200)
    # Stomping equipment
    Com_dev2 = Serial_dev()
    Com_dev2.set_com("COM4")
